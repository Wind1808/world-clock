...
define('world-clock/tests/integration/components/select-tz-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | select-tz', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "/APnnvgL",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"select-tz\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "/6UAb8Uq",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"select-tz\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('world-clock/tests/integration/helpers/is-equal-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Helper | is-equal', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "O8eclxUp",
        "block": "{\"symbols\":[],\"statements\":[[1,[27,\"is-equal\",[[23,[\"inputValue\"]]],null],false]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('world-clock/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/select-tz.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/select-tz.js should pass ESLint\n\n7:18 - \'attrs\' is defined but never used. (no-unused-vars)');
  });

  QUnit.test('controllers/clock.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/clock.js should pass ESLint\n\n16:36 - \'moment\' is not defined. (no-undef)\n20:27 - \'moment\' is not defined. (no-undef)\n27:16 - \'moment\' is not defined. (no-undef)');
  });

  QUnit.test('controllers/timezones.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/timezones.js should pass ESLint\n\n8:23 - \'moment\' is not defined. (no-undef)\n9:22 - \'moment\' is not defined. (no-undef)');
  });
  ...
  QUnit.test('models/timezones.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/timezones.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/timezones.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/timezones.js should pass ESLint\n\n');
  });
});
define('world-clock/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('world-clock/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'world-clock/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('world-clock/templates/clock.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'world-clock/templates/clock.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('world-clock/templates/components/select-tz.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'world-clock/templates/components/select-tz.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('world-clock/templates/timezones.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'world-clock/templates/timezones.hbs should pass TemplateLint.\n\n');
  });
});
define('world-clock/tests/lint/tests.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | tests');

  QUnit.test('integration/components/select-tz-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/select-tz-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/controllers/timezones-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/timezones-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/models/timezones-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/models/timezones-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/routes/timezones-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/timezones-test.js should pass ESLint\n\n');
  });
});
...
define('world-clock/tests/test-helper', ['world-clock/app', 'world-clock/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('world-clock/tests/unit/adapters/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('world-clock/tests/unit/controllers/clock-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('world-clock/tests/unit/controllers/timezones-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Controller | timezones', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    // Replace this with your real tests.
    (0, _qunit.test)('it exists', function (assert) {
      let controller = this.owner.lookup('controller:timezones');
      assert.ok(controller);
    });
  });
});
define('world-clock/tests/unit/models/timezones-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Model | timezones', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('world-clock/tests/unit/routes/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('world-clock/tests/unit/routes/clock-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('world-clock/tests/unit/routes/timezones-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | timezones', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);

    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:timezones');
      assert.ok(route);
    });
  });
});
